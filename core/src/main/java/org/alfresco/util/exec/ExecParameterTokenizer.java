...
public class ExecParameterTokenizer
{
    ...
    public List<@RUntainted String> getAllTokens()
    {
        ...
        if (tokens == null)
        {
            tokens = new ArrayList<@RUntainted String>();
            ...
            else
            {
                ...
                List<Pair<@RUntainted Integer, @RUntainted Integer>> quotedRegions = new ArrayList<Pair<@RUntainted Integer, @RUntainted Integer>>();
    ...
    private Pair<@RUntainted Integer, @RUntainted Integer> findIndexOfClosingQuote(@RUntainted String str, @RUntainted int indexOfStartingQuote, @RUntainted char quoteChar)
    {
        ...
        return new Pair<@RUntainted Integer, @RUntainted Integer>(indexOfStartingQuote, indexAfterClosingQuote);
    }
