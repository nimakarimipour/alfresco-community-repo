...
public class RepositoryContainer extends AbstractRuntimeContainer
{
    ...
    protected void executeScriptInternal(final @RUntainted WebScriptRequest scriptReq, final WebScriptResponse scriptRes, final Authenticator auth)
        throws IOException
    {
        final @RUntainted WebScript script = scriptReq.getServiceMatch().getWebScript();
        ...
        final @RUntainted RequiredAuthentication containerRequiredAuthentication = getRequiredAuthentication();
