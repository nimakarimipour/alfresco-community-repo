...
public class SurfConfigCleaner extends ADMRemoteStore implements BeforeDeleteNodePolicy
{
    ...
    {
        final @RUntainted String userName = (String) nodeService.getProperty(nodeRef, ContentModel.PROP_USERNAME);
        final @RUntainted NodeRef componentsRef = getGlobalComponentsNodeRef();
