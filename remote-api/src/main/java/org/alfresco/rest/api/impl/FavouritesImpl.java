...
public class FavouritesImpl implements Favourites
{
    ...
    @Override
    public Favourite addFavourite(@RUntainted String personId, Favourite favourite, Parameters parameters)
    {
        Favourite ret = null;
    ...
    @Override
    public void removeFavourite(@RUntainted String personId, @RUntainted String id)
    {
    	personId = people.validatePerson(personId, true);
    ...
    @Override
    public Favourite getFavourite(@RUntainted String personId, @RUntainted String favouriteId, Parameters parameters)
    {
    ...
    @Override
    public CollectionWithPagingInfo<Favourite> getFavourites(@RUntainted String personId, final Parameters parameters)
    {
    	personId = people.validatePerson(personId, true);
