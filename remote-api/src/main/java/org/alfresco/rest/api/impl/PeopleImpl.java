...
public class PeopleImpl implements People
{
     ...
     */
    @Override
	public @RUntainted String validatePerson(String personId)
	{
		return validatePerson(personId, false);
	}

    @Override
	public @RUntainted String validatePerson(final String requestedPersonId, boolean validateIsCurrentUser)
	{
