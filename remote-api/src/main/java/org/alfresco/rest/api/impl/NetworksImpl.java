...
public class NetworksImpl implements Networks
{
    ...
    public @RUntainted PersonNetwork getNetwork(@RUntainted String personId, String networkId)
    {
	...
	public CollectionWithPagingInfo<@RUntainted PersonNetwork> getNetworks(@RUntainted String personId, Paging paging)
    {
    	// check that personId is the current user
    	personId = people.validatePerson(personId, true);
